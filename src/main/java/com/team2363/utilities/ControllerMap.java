...
public class ControllerMap {
	...
	public static final int X_BOX_RIGHT_STICK_X = 4;
	public static final int X_BOX_RIGHT_STICK_Y = 5;
	
	//XboxOne Buttons
	public static final int X_BOX_A = 1;
	public static final int X_BOX_B = 2;
	public static final int X_BOX_X = 3;
	public static final int X_BOX_Y = 4;
	public static final int X_BOX_LB = 5;
	public static final int X_BOX_RB = 6;
	public static final int X_BOX_LOGO_LEFT = 7;
	public static final int X_BOX_LOGO_RIGHT = 8;
